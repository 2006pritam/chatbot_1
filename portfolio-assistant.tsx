...
export default function PortfolioAssistant() {
  ...
  const handleSubmitProject = () => {
    ...
    // For this demo, we'll dispatch a custom event that the parent page can listen for
    const newProjectEvent = new CustomEvent("newPortfolioProject", {
      detail: { ...newProject },
    })
  ...
  return (
    <Card className="h-[600px] w-full max-w-[400px] flex flex-col bg-gray-900 border-gray-800 text-white shadow-xl">
